...
echo "🔧 Comprehensive FrancoSphereModels Structure Fix"
echo "================================================="
echo "Rebuilding file with proper structure and all required types"

cd "/Volumes/FastSSD/Xcode" || { echo "❌ Project directory not found"; exit 1; }

# =============================================================================
# COMPREHENSIVE REBUILD OF FrancoSphereModels.swift
# =============================================================================
...
if [[ -f "$FILE" ]]; then
    ...
    echo "🔧 Rebuilding FrancoSphereModels.swift with clean structure..."
...
//  FrancoSphere
//
//  Comprehensive rebuild with all required types
//
...
echo "Building project to verify comprehensive fix..."
BUILD_OUTPUT=$(xcodebuild -project FrancoSphere.xcodeproj -scheme FrancoSphere build -destination "platform=iOS Simulator,name=iPhone 15 Pro" 2>&1)

# Count specific error types
REDECLARATION_ERRORS=$(echo "$BUILD_OUTPUT" | grep -c "Invalid redeclaration" || echo "0")
BRACE_ERRORS=$(echo "$BUILD_OUTPUT" | grep -c "Extraneous.*at top level" || echo "0")
...
echo "• Brace/structure errors: $BRACE_ERRORS"
...
echo "• All type aliases present: $(grep -c "public typealias" "$FILE")"
echo "• DataHealthStatus definition: $(grep -c "enum DataHealthStatus" "$FILE")"
echo "• Proper file ending: $(tail -1 "$FILE" | wc -c) characters in last line"
...
echo ""
echo "🎯 COMPREHENSIVE STRUCTURE FIX SUMMARY"
echo "======================================"
echo ""
echo "✅ Complete rebuild applied:"
echo "• NamedCoordinate: Clean structure with stored lat/lng and computed coordinate"
echo "• All missing types: Properly defined in FrancoSphere namespace"
echo "• DataHealthStatus: Proper enum implementation"
echo "• BuildingTab: Proper struct with static properties"
echo "• All type aliases: Complete and correctly referencing existing types"
echo "• File structure: Clean brace matching and proper syntax"
...
if [[ $TOTAL_ERRORS -eq 0 ]]; then
    ...
    echo "📦 Complete type system with $(grep -c "public struct\|public enum" "$FILE") types defined"
else
    echo "⚠️  $TOTAL_ERRORS errors remain"
    echo "🔧 All structural and redeclaration issues should be resolved"
fi

echo ""
echo "📦 Backup created: $FILE.comprehensive_backup.TIMESTAMP"
