...
enum LocalModels {
    ...
    struct WorkerSkill: Identifiable, Codable, Hashable, Equatable {
        ...
        func compatibleTaskCategories() -> [FrancoSphere.TaskCategory] {
            switch category {
            case .maintenance:
                return [FrancoSphere.TaskCategory.maintenance, FrancoSphere.TaskCategory.repair]
            case .cleaning:
                return [FrancoSphere.TaskCategory.cleaning, FrancoSphere.TaskCategory.sanitation]
            case .repair:
                return [FrancoSphere.TaskCategory.repair, FrancoSphere.TaskCategory.maintenance]
            case .inspection:
                return [FrancoSphere.TaskCategory.inspection]
            case .sanitation:
                return [FrancoSphere.TaskCategory.sanitation, FrancoSphere.TaskCategory.cleaning]
            case .electrical:
                return [FrancoSphere.TaskCategory.maintenance, FrancoSphere.TaskCategory.repair]
            case .plumbing:
                return [FrancoSphere.TaskCategory.maintenance, FrancoSphere.TaskCategory.repair]
            case .hvac:
                return [FrancoSphere.TaskCategory.maintenance]
            case .security:
                return [FrancoSphere.TaskCategory.inspection]
            case .management:
                return [FrancoSphere.TaskCategory.inspection]
        ...
        func maxTaskUrgency() -> FrancoSphere.TaskUrgency {
            switch level {
            case 1: return FrancoSphere.TaskUrgency.low
            case 2: return FrancoSphere.TaskUrgency.medium
            case 3: return FrancoSphere.TaskUrgency.medium
            case 4: return FrancoSphere.TaskUrgency.high
            case 5: return FrancoSphere.TaskUrgency.urgent
            default: return FrancoSphere.TaskUrgency.low
            }
        }
        
        /// Determines if the worker can handle a specific task based on task category and urgency.
        func canHandle(taskCategory: FrancoSphere.TaskCategory, urgency: FrancoSphere.TaskUrgency) -> Bool {
        ...
        private func getUrgencyValue(_ urgency: FrancoSphere.TaskUrgency) -> Int {
            switch urgency {
            case .low: return 1
