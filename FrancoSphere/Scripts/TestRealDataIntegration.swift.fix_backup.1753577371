...
enum IntegrationTest {
    ...
    static func runFullIntegrationTest() async -> Bool {
        ...
        if await testCoreTypes.PortfolioIntelligence() {
    ...
    private static func testCoreTypes.PortfolioIntelligence() async -> Bool {
        do {
            let intelligence = await RealDataFactory.createRealCoreTypes.PortfolioIntelligence()
