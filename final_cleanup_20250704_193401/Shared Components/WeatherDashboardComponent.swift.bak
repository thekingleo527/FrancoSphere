    ...
    private func currentWeatherView(_ weather: WeatherData) -> some View {
        HStack(spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                HStack(spacing: 6) {
                    Circle()
                        .fill(getRiskColor(OutdoorWorkRisk.low))
                        .frame(width: 8, height: 8)
                    
                    Text(OutdoorWorkRisk.low.rawValue)
                        .font(.caption)
                        .foregroundColor(getRiskColor(OutdoorWorkRisk.low))
                }
            }
        ...
        .background(
            RoundedRectangle(cornerRadius: 10)
                ...
                .overlay(
                    RoundedRectangle(cornerRadius: 10)
                        .stroke(
                            OutdoorWorkRisk.low == .extreme ? Color.red.opacity(0.5) : Color.clear,
                            lineWidth: 2
                        )
                )
        )
