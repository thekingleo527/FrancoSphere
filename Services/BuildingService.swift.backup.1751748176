...
actor BuildingService {
    ...
    private init() {
        ...
        self.buildings = [
            NamedCoordinate(id: "1", name: "12 West 18th Street", latitude: 40.7390, longitude: -73.9930),
            NamedCoordinate(id: "2", name: "29-31 East 20th Street", latitude: 40.7380, longitude: -73.9880),
            NamedCoordinate(id: "3", name: "135-139 West 17th Street", latitude: 40.7398, longitude: -73.9972),
            NamedCoordinate(id: "4", name: "104 Franklin Street", latitude: 40.7180, longitude: -74.0060),
            NamedCoordinate(id: "5", name: "138 West 17th Street", latitude: 40.7400, longitude: -73.9970),
            NamedCoordinate(id: "6", name: "68 Perry Street", latitude: 40.7350, longitude: -74.0050),
            NamedCoordinate(id: "7", name: "136 West 17th Street", latitude: 40.7402, longitude: -73.9970),
            NamedCoordinate(id: "8", name: "41 Elizabeth Street", latitude: 40.7170, longitude: -73.9970),
            NamedCoordinate(id: "9", name: "117 West 17th Street", latitude: 40.7395, longitude: -73.9950),
            NamedCoordinate(id: "10", name: "131 Perry Street", latitude: 40.7340, longitude: -74.0060),
            NamedCoordinate(id: "11", name: "123 1st Avenue", latitude: 40.7270, longitude: -73.9850),
            NamedCoordinate(id: "12", name: "178 Spring Street", latitude: 40.7250, longitude: -74.0020),
            NamedCoordinate(id: "13", name: "112 West 18th Street", latitude: 40.7400, longitude: -73.9940),
            ...
            NamedCoordinate(id: "15", name: "133 East 15th Street", latitude: 40.7345, longitude: -73.9875),
            NamedCoordinate(id: "16", name: "Stuyvesant Cove Park", latitude: 40.7318, longitude: -73.9740),
            NamedCoordinate(id: "17", name: "36 Walker Street", latitude: 40.7190, longitude: -74.0050),
            NamedCoordinate(id: "18", name: "115 7th Avenue", latitude: 40.7380, longitude: -73.9980)
        ]
    ...
    private func getKevinCorrectedAssignments() async -> [NamedCoordinate] {
        return [
            ...
            NamedCoordinate(id: "5", name: "138 West 17th Street", latitude: 40.7400, longitude: -73.9970),
            NamedCoordinate(id: "2", name: "29-31 East 20th Street", latitude: 40.7388, longitude: -73.9892),
    ...
    func saveInventoryItem(_ item: InventoryItem) async throws {
        ...
        let parameters: [SQLiteBinding] = [
            ...
            item.quantity, item.category.rawValue, item.minimumQuantity, needsReorderInt,
