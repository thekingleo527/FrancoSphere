...
class WorkerDashboardViewModel: ObservableObject {
    ...
    @Published var clockInStatus: ClockInStatus = .clockedOut
...
struct WorkerShift {
    ...
    let workerId: String
    let startTime: Date
    let startBuilding: FrancoSphere.NamedCoordinate
    var endTime: Date?
...
enum ClockInStatus: Equatable {
    case clockedOut
    case clockedIn(building: String)
...
enum DashboardError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .noBuildingsAssigned:
            return "No buildings assigned to this worker"
        case .noTasksAvailable:
            return "No tasks available for today"
        case .workerNotFound:
